...
test("none of the eight cross-domain handshake routes compiles", () => {
  /*
   * Walked, not listed — `tsc` moves with the workspace layout and a candidate list is a list of
   * guesses about which one is in force. See `i5-blob-separation.test.ts` for the full note.
   */
